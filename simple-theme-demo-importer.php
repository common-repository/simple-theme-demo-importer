...
class simple_theme_demo_importer
{
	function __construct()
	{
		...
		/** Deactivation Hook **/
		register_deactivation_hook( __FILE__, array($this,'simple_theme_demo_importer_deactivation' ));		
		/*** Status Page ***/
		add_action('admin_menu', array($this,'simple_theme_demo_importer_add_status_page'));
	}//end of constructor
	...
	function simple_theme_demo_importer_deactivation()
	{
		flush_rewrite_rules();
	}//end of function
	function simple_theme_demo_importer_add_status_page() 
	{
		add_submenu_page('simple-theme-demo-importer','Simple theme demo import', 'Status', 'edit_theme_options', 'simple-theme-demo-importer-status-page', array($this,'simple_theme_demo_importer_status_page_menu'),SIMPLE_THEME_DEMO_IMPORT_PLUGIN_URL.'/images/import.png',62);
	}//end of function
	function simple_theme_demo_importer_status_page_menu()
	{		
		$file='status-report.php';
		require_once( SIMPLE_THEME_DEMO_IMPORT_PLUGIN_TEMPLATE_DIR.$file);		
	}//end of function
